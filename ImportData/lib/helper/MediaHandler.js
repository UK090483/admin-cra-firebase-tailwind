...
var MediaHandler = /** @class */ (function () {
    function MediaHandler(url, id, folder) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this.rootFolder + "/" + this.id + "/" + this.folder + "/" + this.fileName];
                }
            });
        }); };
        ...
        this.optimize = function (file) { return __awaiter(_this, void 0, void 0, function () {
            var files, result, _loop_1, _i, files_1, file_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        files = file ? [file] : this.localUrl;
                        if (!files) {
                            console.log("no files To Optimize");
                            return [2 /*return*/];
                        }
                        result = [];
                        _loop_1 = function (file_1) {
                            var output;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        output = file_1.replace(path_1.basename(file_1), "optimized_" + path_1.basename(file_1));
                                        return [4 /*yield*/, sharp_1.default(file_1)
        ...
        this.handlePDF = function () { return __awaiter(_this, void 0, void 0, function () {
            var pdfImage, _a, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        pdfImage = new PDFImage(this.rootFolder + "/" + this.id + "/" + this.folder + "/" + this.fileName, {
                            convertOptions: {
                                "-background": "white",
                                "-alpha": "remove",
                                "-flatten": "",
        ...
        this.prepare = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        if (!(this.type === "pdf")) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.handlePDF()];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3: return [4 /*yield*/, this.optimize()];
                    case 4:
                        _a.sent();
                        if (this.type === "pdf") {
                            return [2 /*return*/, { type: this.type, src: this.result, original: this.original }];
                        }
                        return [2 /*return*/, { type: this.type, src: this.result[0] }];
                }
            });
        }); };
        this.url = url;
        ...
        this.fileName = path_1.basename(this.url);
