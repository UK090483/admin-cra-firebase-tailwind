...
exports.parseJotFormData = void 0;
var lodash_1 = require("lodash");
var jotFormDataMapper = {
    id: "id",
...
var parseJotFormData = function (jotFormData) {
    var res = {};
    Object.keys(jotFormDataMapper).forEach(function (element) {
        var val = lodash_1.get(jotFormData, jotFormDataMapper[element]);
        if (val) {
            res[element] = val;
        }
    });
...
exports.parseJotFormData = parseJotFormData;
